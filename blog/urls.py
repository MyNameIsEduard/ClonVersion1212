...
from .views import HomePageView, PublicationCreateView, PublicationDetailView, PublicationUpdateView, PublicationDeleteView
...
urlpatterns = [
    ...
    path("publication/<int:pk>/edit/", PublicationUpdateView.as_view(), name="publication_update"),
